...
<div class="support-left">
    ...
    <?php echo l(t('Register Now!'), $event_url, array('attributes' => array('target'=>'_blank'))); ?>
    <?php
        }
    ?>
</div>
<div class="support-right">
    <div class="left">
        ...
        <p>
            <?php 
            //echo t('Give a general donation to this event or find a current fundraiser to support.'); 
            echo t('Find a Derby fundraiser to support');
            ?>
        </p>
        ...
        <select name="racer" id="racer-select" class="form-select">
            ...
            <?php
                ...
                foreach($pcps as $pcp) {            
                    ...
                    $pcp_members[$url]  = isset($fake_user->displayname) ? $fake_user->displayname : '(temporarily unavail)';
        ...
        if(!empty($give_url)) {
        ?>
            <a href="<?php echo $give_url; ?>" target="_blank" class="general-donation btn"><span><?php echo t('Give a General Donation to PWSACO'); ?></span></a>
        <?php
        }
        ?>
    </div>
    <div class="right">
        ...
        <p>
            <?php //echo t('It\'s not too late to join the race and raise money for the event.'); 
                echo t('Become a Derby Fundraiser:');
            ?>
        </p>
<?php
    if($user->uid>0) {
