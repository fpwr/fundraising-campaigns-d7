<?php
    ...
    if($mode_type != 'walking') {     
        ...
        $campaign_id    = !is_null($campaign) ? $campaign->nid : NULL;
    ...
    if(!is_null($campaign)) {
        $location_text          = isset($campaign->field_dw_campaign_location['und']['0']['value']) ? $campaign->field_dw_campaign_location['und']['0']['value'] : '<!-- no location text -->';
    } else {
