<?php
    ...
    $details = isset($node->body['und']['0']['value']) ? $node->body['und']['0']['value'] : NULL;
    ...
    if($mode_type == 'walking') {
        ...
        if(!empty($campaign->field_dw_contact_email['und']['0']['value'])) {
            $volunteer_email    = $campaign->field_dw_contact_email['und']['0']['value'];
        }
    ...
    if(isset($_SESSION['softContribution']) && ($pcp->id == $_SESSION['softContribution']->pcp_id)) {
        if($_SESSION['softContribution']->contribution_id == $_SESSION['contribution']->id) {
            ...
            $ty_title   = isset($campaign->field_dw_thankyou_title['und']['0']['value'])  ? $campaign->field_dw_thankyou_title['und']['0']['value'] : '';
            $ty_text    = isset($campaign->field_dw_thankyou_text['und']['0']['value'])   ? $campaign->field_dw_thankyou_text['und']['0']['value'] : '';
            $ty_footer  = isset($campaign->field_dw_thankyou_footer['und']['0']['value']) ? $campaign->field_dw_thankyou_footer['und']['0']['value'] : '';
...
<?php
    ...
    $event_date = isset($node->field_dw_event_date['und']['0']['value']) ? $node->field_dw_event_date['und']['0']['value'] : '';
    $event_time = isset($node->field_dw_event_time['und']['0']['value']) ? $node->field_dw_event_time['und']['0']['value'] : '';
...
-->
            ...
            <div class="event donate-box">
                ...
                <p><?php echo t('We would love you to attend the event in person.'); ?> 
                <table>
                    <tr class="name">
...
-->
            ...
            <div class="get-involved donate-box">
                ...
                <p><?php echo t('Consider helping us in one of the following ways:'); ?></p>
                <ul>
