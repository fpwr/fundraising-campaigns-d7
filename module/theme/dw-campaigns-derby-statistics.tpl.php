<?php
    ...
    if(!is_null($campaign)) {
        $daysEnd                        = isset($campaign->field_dw_date_range['und']['0']['value2']) ? strtotime($campaign->field_dw_date_range['und']['0']['value2']) : 0;
        $timeNow                        = time();
...
<ul class="stats">
	...
	<li>
		<span class="dollar-label"><?php echo t('Goal:'); ?></span>
...
?>
	<span class="days"></span><?php echo t('Campaign Complete'); ?>
<?php
}
?>
